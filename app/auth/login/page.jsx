              ...
              <form>
                ...
                <div className="mb-5 mt-20">
                  <input
                    type="submit"
                    value="Sign In"
                    className="w-full cursor-pointer border border-primary bg-primary p-4 text-white font-black font-orbitron hover:bg-gradient-to-r hover:border-0 hover:from-[#7E51F8] hover:to-[#D007A6]"
                  />
                </div>

                <button className="flex w-full items-center justify-center gap-3.5 border border-stroke bg-gray p-4 dark:border-strokedark dark:bg-meta-4  text-white font-black font-orbitron hover:bg-gradient-to-r hover:border-0 hover:from-[#7E51F8] hover:to-[#D007A6]">
                  <span>
                    <svg
                      width="20"
                      height="20"
