...
<div className="flex flex-col items-center overflow-x-hidden lg:py-[80px] lg:pb-[100px] lg:pt-[50px]">
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-8 justify-center w-full max-w-7xl">
    {/* First Row: First 3 Cards */}
    {faqEntries.slice(0, 3).map((experience, index) => (
      <div
        key={index}
        className="overflow-hidden bg-[#002718] mt-5 flex flex-col items-center h-[600px] w-[363px] mx-auto"
      >
        <div className="flex justify-center items-center w-full h-[282px]">
          <Image
            src=""
  ...
  {/* Second Row: 4th and 5th Cards */}
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 justify-center w-full max-w-7xl mt-10">
    {faqEntries.slice(3, 5).map((experience, index) => (
      <div
        key={index}
        className="overflow-hidden bg-[#002718] mt-5 flex flex-col items-center h-[600px] w-[550px] mx-auto"
      >
        <div className="flex justify-center items-center w-full h-[282px]">
          <Image
            src=""
