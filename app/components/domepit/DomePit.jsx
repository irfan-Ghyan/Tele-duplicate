   ...
   <div className=' px-4 flex flex-col justify-between md:mt-[36px] md:mb-[41px]'>
     {pitEntries.map((pit, index) => (
       <div key={index} className='py-[15px] lg:py-[30px] lx:pt-[70px] lg:mt-[0px]'>
         ...
         <h1 className='text-[34px] md:text-[54px] text-white font-black font-orbitron drop-shadow-4xl'>{pit.title}</h1>
         <p className='md:w-[400px] lg:w-[550px] xl:w-[600px] md:text-[14px] lg:text-[18px] text-white font-bold font-jura mt-6 text-balance drop-shadow-4xl text-justify'>{pit.description}</p>
       </div>
     ))}
