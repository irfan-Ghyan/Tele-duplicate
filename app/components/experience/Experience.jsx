...
//                 <div
//                   key={index}
//                   className="overflow-hidden bg-[#002718] flex flex-col items-center  justify-between sm:w-[330px] lg:w-[360px] mx-auto my-8 h-[760px] "
//                 >
//                   <div className="flex justify-center items-center w-full h-[282px]">
//                     <Image
//                       src={experience.imageUrl}
...
//                 <div
//                   key={index}
//                   className="overflow-hidden bg-[#002718] flex flex-col items-center justify-between h-[760px] sm:w-[330px] lg:w-[360px] mx-auto my-8"
//                 >
//                   <div className="flex justify-center items-center w-full h-[282px]">
//                     <Image
//                       src={experience.imageUrl}
