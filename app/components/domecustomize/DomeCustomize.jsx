   ...
   <div className='flex flex-col justify-between py-[30px]'>
        ...
        <div key={index} className='order-1 lg:order-2 lg:w-1/2  px-0 md:px-4 lg:px-4 xl:px-4'>
            <div  className=' flex flex-col justify-center flex-grow-4 '>
                ...
                <h1 className='text-[24px] md:text-[38px] text-white font-black font-orbitron mt-6'>{customize.title}</h1>
                <p className='md:w-[400px] lg:w-[550px] xl:w-[600px] md:text-[14px] lg:text-[18px] text-white font-bold font-jura mt-6 text-justify'>{customize.description}</p>
            </div>
            {/* <div className='py-10'>
