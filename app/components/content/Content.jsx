  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center overflow-x-hidden lg:py-[80px] lg:pb-[100px] lg:pt-[50px]">
        <div className="flex items-center justify-center xl:px-40 lg:px-20 sm:px-4 md:flex lg:flex xl:flex xl:justify-center gap-4 my-6 ">
        ...
        <div className="w-full">
          <div className="flex flex-col lg:flex-row xl:flex-row justify-center items-center gap-4 ">
            ...
            {!loading &&
              ...
              faqEntries.slice(0, 1).map((experience, index) => (
                <div
                  key={index}
                  className="overflow-hidden bg-[#002718] flex flex-col items-center h-[650px] sm:w-[330px] lg:w-[360px] lg:my-8"
                >
          ...
          {/* <div className="xl:flex xl:justify-center flex-wrap gap-2 lg:mx-80 "> */}
            {faqEntries.slice(3, 5).map((experience, index) => (
              <div
                key={index}
                className="overflow-hidden bg-[#002718] flex flex-col items-center h-[650px] sm:w-[330px] lg:w-[360px] lg:my-8 my-4"
              >
                <div className="flex justify-center items-center w-full h-[282px]">
                  <Image
                    src={experience.imageUrl}
