   ...
   <div className='px-4 flex flex-col justify-between md:mt-[36px] md:mb-[41px] max-w-7xl'>
     {domes.map((dome, index) => (
       <div key={index} className='py-[15px] lg:py-[50px] md:w-[400px] lg:w-[700px] xl:w-[700px] '>
         ...
         <p className='md:text-[14px] lg:text-[18px] text-[#e3ce90] font-black font-jura mt-6 text-balance drop-shadow-4xl lg:leading-8 xl:leading-8 text-justify'>{dome.description}</p>
         <p className='md:text-[14px] lg:text-[18px] text-[#e3ce90] font-black font-jura mt-6 text-balance drop-shadow-4xl lg:leading-8 xl:leading-8 text-justify'>{dome.description1}</p>
         <p className='md:text-[14px] lg:text-[18px] text-[#e3ce90] font-black font-jura mt-6 text-balance drop-shadow-4xl lg:leading-8 xl:leading-8 text-justify'>{dome.description2}</p>
         <p className='md:text-[14px] lg:text-[18px] text-[#e3ce90] font-black font-jura mt-6 text-balance drop-shadow-4xl lg:leading-8 xl:leading-8 text-justify'>{dome.description3}</p>
       </div>
     ))}
