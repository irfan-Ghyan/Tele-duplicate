...
//       <div className="relative w-full h-[240px] md:h-[319px] hover-trigger" style={{ backgroundImage: "url('/assets/images/events/Stage.png')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
