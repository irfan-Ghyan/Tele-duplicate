...
//         const domeSection = sectionData.data.sections.find((section) => section.title === 'Gaming Room');
    ...
    try {
      ...
      if (sectionData.success) {
        const domeSection = sectionData.data.sections.find(
          (section) => section.title === 'Gaming Room'
        );
            ...
            <div className="px-4 flex flex-col justify-between md:mt-[36px] md:mb-[41px]">
              ...
              <div className="flex items-start m-bottom">
                <div className="py-10">
                  <Link
                    href="/experience"
                    className="button-slanted w-[200px] lg:w-[233px] h-[44px] px-8 py-6 button font-jura font-bold bg-gradient-to-r from-[#c09e5f] to-[#e3ce90] text-[#002718] ml-2 transition duration-300 rounded-tl-lg rounded-br-lg flex items-center justify-center"
                  >
                    <span className="button-slanted-content">{t('VIEW_OPTIONS')}</span>
                  </Link>
                </div>
