...
//               <div className="relative z-10 flex flex-col sm:w-full h-[569px] md:w-[260px] md:h-[644px] lg:w-[360px] lg:h-[644px]">
//                 {openDropdown === exp.id ? (
...
//                   <p className="text-white font-normal md:w-[270px] lg:w-[270px] font-jura text-[16px] mb-4">{exp.description}</p>
//                   <p className="text-white font-normal md:w-[270px] lg:w-[270px] font-jura text-[16px] mb-4">{exp.description1}</p>
//                 </div>
//                 <div className="p-4 pt-0 mb-6">
//                   {/* Link for navigation */}
//                   <Link href={`/booking/${exp.id}`} passHref>
//                     <button className="button-slanted w-full md:w-[220px] lg:w-[250px] h-[47px]  font-jura text-[16px] font-bold leading-[24px] bg-gradient-to-r cursor-pointer from-[#df2a27e3] to-[#df2a27] text-white transition duration-300 rounded-tl-lg rounded-br-lg flex items-center justify-center">
//                       {exp.buttonText}
//                     </button>
//                   </Link>
//                 </div>
