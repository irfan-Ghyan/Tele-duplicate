...
//         const url = `${baseUrl}/api/content/sections/Upcoming Events`;
...
//         const domeSection = data?.data?.sections.find((section) => section.title === 'Virtual GP');
//         if (domeSection) {
...
//   return (
//     <div className={`w-full py-[40px] md:py-[50px] lg:py-[100px] bg-white px-40 ${language === 'ar' ? 'text-right' : 'text-left'}`}>
