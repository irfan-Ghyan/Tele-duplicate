  ...
  return (
    <footer className="bg-[#4B1870] text-white pt-10 lg:pt-20 px-8 lg:px-20 padding-px xl:px-40 max-w-full overflow-hidden">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="flex flex-col">
          <h3 className="text-white font-orbitron text-[20px] font-normal mb-4">{t('quick_links')}</h3>
          <ul className="space-y-2">
            <li>
              <Link href="/experience" className="hover:underline text-white font-jura text-[13px] font-bold">
                {t('experiences')}
        ...
        <div className="flex flex-col">
          <h3 className="text-white font-orbitron text-[20px] font-normal mb-4">{t('location_time')}</h3>
          <div>
            <div className="mb-[10px]">
              <h3 className="text-white font-jura text-[13px] font-bold">{t('address')}</h3>
              <Link href="https://g.co/kgs/pvUAcQh" target="_blank" rel="noopener noreferrer" className="text-white font-jura text-[13px] font-bold hover:underline">D-65 - Dubai Production City - Dubai, UAE</Link>
            </div>
            <div className="mt-[10px]">
              <h3 className="text-white font-jura text-[13px] font-bold">{t('hours')}</h3>
              <p className="text-white font-jura text-[13px] font-bold">Tuesday - Sunday 12PM to 11PM</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col">
          <h3 className="text-white font-orbitron text-[20px] font-normal mb-4">{t('get_in_touch')}</h3>
          <div className="mb-[10px]">
            <div className="flex">
              <Image src="/assets/images/dome/phone.png" alt="Phone Icon" height={12} width={12} className="w-[9px] h-[9px] mt-[5px]" priority={true} />
              <p className="text-white font-jura text-[13px] font-bold ml-1">{t('phone')}</p>
            </div>
            <div>
              <Link href="tel:+9715554894679" className="text-white font-jura text-[13px] font-bold hover:underline">+971 55 489 4679</Link>
            </div>
          </div>
          <div className="mt-[10px]">
            <div className="flex">
              <Image src="/assets/images/dome/email.png" alt="Email Icon" height={12} width={12} className="w-[9px] h-[9px] mt-[5px]" priority={true} />
              <p className="text-white font-jura text-[13px] font-bold ml-1">{t('email')}</p>
            </div>
            <Link href="mailto:info@teleiosdome.ae" className="text-white font-jura text-[13px] font-bold hover:underline">info@teleiosdome.ae</Link>
          </div>
        </div>
      </div>
      <div className="mt-[60px] container mx-auto">
        <div className="md:flex justify-between">
          <div>
            <p className="text-white font-jura text-[11px] md:text-[13px] font-bold opacity-60">{t('all_rights_reserved')}</p>
          </div>
          <div className="md:text-end">
            <Link href="/privacy" className="text-white font-jura text-[11px] md:text-[13px] font-bold opacity-60 hover:underline">{t('privacy_policy')}</Link>
            <span className='mx-1 font-jura text-[11px] md:text-[13px] font-bold text-white opacity-60'> | </span>
            <Link href="/terms&conditions" className="text-white font-jura text-[11px] md:text-[13px] font-bold opacity-60 hover:underline">{t('terms_conditions')}</Link>
          </div>
        </div>
      </div>
      <div className="bg-banner-bg bg-cover bg-center flex items-center justify-center text-white relative pl-20">
